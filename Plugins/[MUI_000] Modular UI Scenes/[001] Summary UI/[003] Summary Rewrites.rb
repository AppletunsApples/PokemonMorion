...
class PokemonSummary_Scene
  ...
  def pbOptions
    ...
    options.each do |cmd|
      ...
      when :nickname then commands[cmd] = _INTL("Nickname")      if Settings::MECHANICS_GENERATION >= 9
      ...
      when :tms      then commands[cmd] = _INTL("Use TMs")      if Settings::MECHANICS_GENERATION >= 9 && $bag.has_compatible_tm?(@pokemon)
